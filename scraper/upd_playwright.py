...
def download_images(image_links, save_dir="data/images/downloaded"):
...
async def scrape_product_page(url):
    async with async_playwright() as p:
        ...
        print(f"\n\u2B07\uFE0F Downloading {len(image_urls)} total images...")
...
if __name__ == "__main__":
    ...
    data = asyncio.run(scrape_product_page(dress_url))
    ...
    print("\n\u2705 Data saved: dress_details.txt, Size_guide.json, and all downloaded images.")
